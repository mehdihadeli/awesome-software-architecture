...
- [Injecting Secrets into Kubernetes Pods via Vault Helm Sidecar](https://learn.hashicorp.com/vault/kubernetes/sidecar)
...
- [hashicorp-education/learn-vault-secrets-dotnet-vault](https://github.com/hashicorp-education/learn-vault-secrets-dotnet-vault) - Supporting content for the Using HashiCorp Vault C# Client with .NET Core tutorial
