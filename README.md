...
- [Architectural Patterns](docs/architectural-patterns/architectural-patterns.md)
  - [Domain Driven Design](docs/architectural-patterns/domain-driven-design/index.md)
  - [Data Driven Design](docs/architectural-patterns/data-driven-design.md)
  - [CQRS](docs/architectural-patterns/cqrs.md)
  - [Event Sourcing](docs/architectural-patterns/event-sourcing.md)
  - [Microservices](docs/architectural-patterns/microservices/index.md)
  ...
  - [Modular Monolith Architecture](docs/architectural-patterns/modular-monolith.md)
...
- [Cloud Native](docs/cloud-native/index.md)
  - [API Gateway](docs/cloud-native/api-gateway/index.md)
  - [Container Runtime](docs/cloud-native/container-runtime/index.md)
  - [Kubernetes](docs/cloud-native/kubernetes/index.md)
  - [Load Balancing](docs/cloud-native/load-balancing/index.md)
  - [Reverse Proxy](docs/cloud-native/reverse-proxy/index.md)
  - [Service Discovery & Registry](docs/cloud-native/service-discovery/index.md) 
  - [Service Mesh](docs/cloud-native/service-mesh/index.md)
